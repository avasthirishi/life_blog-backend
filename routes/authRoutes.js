...
// Public routes (no authentication required)
// Remove /api/auth prefix - it's already in index.js
router.post('/signup', signup);  // Changed from '/api/auth/signup'
router.post('/login', login);    // Changed from '/api/auth/login'
